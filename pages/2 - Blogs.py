...
st.write(
   """
    ...
    7. [AdaLoRA](https://athekunal.medium.com/adaptive-lora-adalora-paper-explanation-7cb5ac04d0cb)
    ...
    3. [Trust regions methods TRPO and PPO](https://medium.com/analytics-vidhya/trust-region-methods-for-deep-reinforcement-learning-e7e2a8460284)
    4. [Soft-Actor Critic](https://medium.com/analytics-vidhya/soft-actor-critic-algorithms-in-deep-reinforcement-learning-a11bedd9aa20) 
    ...
    ### Deep RL in finance Project with Professor Damien Ernst
    1. [Deep RL using Google trends data](https://medium.com/mlearning-ai/google-trends-data-for-automated-stock-trading-using-reinforcement-learning-9c0fd6d00678): The Internet is one of the primary sources of information for financial transactions, and it is more important as more retail investors are entering the market. So, we examined the benefits of having Google trends data as state space for our RL trading agent and we got satisfactory results for stocks like Tesla and cryptocurrencies. 
    2. [GitHub Link](https://github.com/Athe-kunal/Reinforcement-learning-trading-agent-using-Google-trends-data)
    
    ### Deep Reinforcement learning in Finance
    1. [Deep RL in finance Part I.](https://medium.com/analytics-vidhya/deep-reinforcement-learning-in-algorithmic-trading-part-i-7088a4befd60)
    ...
    1. [Hyperparameter Optimization using Weights & Biases](https://medium.com/analytics-vidhya/weights-and-biases-ify-stable-baselines-models-in-finrl-f11b67f2a6a7)
    2. [Hyperparameter Optimization using Optuna](https://medium.com/analytics-vidhya/hyperparameter-tuning-using-optuna-for-finrl-8a49506d2741)
    3. [Hyperparameter Optimization using Ray tune](https://medium.com/mlearning-ai/hyperparameter-optimization-using-ray-tune-for-finrl-models-42df2937d53d)
    ...
    2. [THE REAL THREATS OF AI II](https://astaragmohapatra.blogspot.com/2021/01/the-real-threats-of-ai-part-ii-glad-you.html)
    3. [CSAM Detection by Apple](https://medium.com/nerd-for-tech/csam-detection-by-apple-explained-387970f52510)
    4. [WHY WE SHOULD KEEP GOING TO SPACE](https://astaragmohapatra.blogspot.com/2022/01/why-we-should-keep-going-to-space.html)
    5. [WHY CONSPIRACIES WORK SO WELL?](https://astaragmohapatra.blogspot.com/2021/05/why-conspiracies-work-so-well.html)
    6. [Why Following trends is hurting Humanity?](https://astaragmohapatra.blogspot.com/2022/07/why-following-trends-is-hurting-humanity.html)
""" 
)